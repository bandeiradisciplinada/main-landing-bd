                  ...
                  <form onSubmit={handleSubmit} className="mt-3">
                    <div className="mb-4 text-left">
                      ...
                      <textarea
                        ...
                        className="appearance-none block w-full px-4 py-3 border border-border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary sm:text-lg"
